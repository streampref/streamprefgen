...
def main():
    ...
    '''
    args = get_arguments()
    exp_list = gen_experiment_list(MAXSEQ_CONF)
    if args.gen:
        create_directories(MAXSEQ_CONF, exp_list)
        print 'Generating stream data'
        gen_all_streams(MAXSEQ_CONF, exp_list)
        ...
        summarize_all(MAXSEQ_CONF, RUN_COUNT)
